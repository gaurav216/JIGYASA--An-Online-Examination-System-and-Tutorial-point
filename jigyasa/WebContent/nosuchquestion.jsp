    ...
    <section id="main-content">
      ...
      <div class="panel-body">
                <div class="alert alert-danger fade in">
                  ...
                  <strong>No such question exists!!!</strong><br>Make sure you selected the correct subject and entered a valid question id
                </div>
                <br><h2>
        Select the subject whose questions you want to modify
      </h2>
                <a class="btn btn-primary btn-lg" href="findquestion.jsp?subject=maths" title="Maths">Maths</a>
      <a class="btn btn-success btn-lg" href="findquestion.jsp?subject=reasoning" title="Reasoning">Reasoning</a>
      <a class="btn btn-danger btn-lg" href="findquestion.jsp?subject=english" title="English">English</a>
       <a class="btn btn-primary btn-lg" href="findquestion.jsp?subject=genaw" title="General Awareness">General Awareness</a>
      <a class="btn btn-success btn-lg" href="findquestion.jsp?subject=gensc" title="General Science">General Science</a>
      <a class="btn btn-danger btn-lg" href="findquestion.jsp?subject=gatecse" title="GATE CSE">GATE CSE</a>
       <a class="btn btn-primary btn-lg" href="findquestion.jsp?subject=jee" title="JEE">JEE</a>
